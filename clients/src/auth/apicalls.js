...
export const createProject = (userId,token,project) => {
    ...
    return fetch(`${API}/user/${userId}/project/create`,{
        method: "POST",
        headers: {
            Accept: "application/json",
            "Authorization" : `Bearer ${token}`,
...
export const freelancerGetAllProjects = (userId) => {
    return fetch(`${API}/user/${userId}/projects/all`,{
        method: "GET",
        headers: {
            Accept: "application/json",
        },
...
export const updateProject = (projectId,userId,token,project) => {
    return fetch(`${API}/user/${userId}/project/update/${projectId}`,{
        method: "PUT",
        headers: {
            Accept: "application/json",
            "Authorization" : `Bearer ${token}`,
...
export const deleteProject = (projectId,userId,token) => {
    return fetch(`${API}/user/${userId}/project/delete/${projectId}`,{
        method: "DELETE",
        headers: {
            Accept: "application/json",
            "Authorization" : `Bearer ${token}`,
...
export const sortByDate = (userId,token) => {
    ...
    return fetch(`${API}/user/${userId}/project/view/sortedByDate`,{
        method: "GET",
        headers: {
            Accept: "application/json",
            "Authorization" : `Bearer ${token}`,
...
export const sortByPriority = (userId,token) => {
    return fetch(`${API}/user/${userId}/project/view/sortedByPriority`,{
        method: "GET",
        headers: {
            Accept: "application/json",
            "Authorization" : `Bearer ${token}`,
